...
func main() {
	...
	mux.HandleFuncC(pat.Post("/adapter"), adapter)
...
func adapter(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	req := &PayData{}
...
func Aggregate(data PayData) {
	fmt.Printf("This is the data in the aggregate: %+v\n", data)

	url := "http://dockerhost:8003/aggregate"
	fmt.Println("URL:>", url)
