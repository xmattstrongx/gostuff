...
func main() {
	...
	mux.HandleFuncC(pat.Post("/gateway"), gateway)
...
func gateway(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	req := &PayData{}
	fmt.Println("MATT MATT")
...
func Adapter(data PayData) {
	fmt.Printf("This is the data in the aggregate: %+v\n", data)

	url := "http://dockerhost:8002/adapter"
	fmt.Println("URL:>", url)
